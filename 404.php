	...
	<main id="wsuwp-main" class="spine-blank-template wsu-error-content">
		<section class="row side-right gutter">
			...
			<div class="column one">
				...
				<h2>Page not found. <span class="error-404-text">404 Error</span></h2>

				<p>
					The address that you tried was not found. You may have used an outdated link or typed the URL incorrectly. Please try our site search or one of these links.
				</p>
